...
*/
    ...
    @Ignore
    public FavoriteEntry(int id, String idDrink, String strDrink, String strDrinkThumb) {
    ...
    public FavoriteEntry(String idDrink, String strDrink, String strDrinkThumb) {
